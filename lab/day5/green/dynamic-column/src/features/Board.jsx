...
import { Box, Stack, Button, Dialog, DialogTitle, DialogContent, DialogActions, TextField } from '@mui/material'
          ...
          {state.columnOrder.map((colId, index) => {
            ...
            return (
              <Box
                key={colId}
                sx={{
                  flex: { xs: '0 0 280px', md: '0 0 340px' }, // column width
              ...
              >
                <Column
                  ...
                  onRename={(title) =>
                    dispatch({ type: 'RENAME_COLUMN', payload: { id: colId, title } })
                  }
